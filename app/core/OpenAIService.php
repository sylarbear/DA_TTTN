...
class OpenAIService
{
    ...
    /**
     * Lấy API key từ .env (ưu tiên) hoặc file config cũ (backward compat)
     */
    public static function getApiKey()
    {
        ...
        // Ưu tiên đọc từ Env (từ file .env)
        if (class_exists('Env')) {
    ...
    /**
     * Lưu API key (ghi vào file config cũ để backward compat)
     */
     ...
     * @return array|null Scores + AI feedback
     */
    public static function scoreSpeaking($transcript, $sampleAnswer): ?array
    {
